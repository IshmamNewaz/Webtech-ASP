...
require('../Models/ViewAllNotice.php');
...
<body>	
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h2 class="mb-4 text-center">------View Notice------</h2>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                        <th scope="col">Notice Info</th>
                                ...
                                <tbody>
                                  <?php 
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $fields['notice']?></td>
                                      <td><?php echo $fields['date']?></td>
                                      <form method="POST" action="../Controllers/deleteNotice.php">
  ...
  <div class="container-fluid pt-4 px-4">
    <h2 class="mb-4 text-center">------NOTICE ENTRY------</h2>
    <div class="row g-4">
      <form action="../Controllers/inputNotice.php" method="POST" class="row g-4">
        ...
        <div class="col-sm-12 col-xl-9">
          <div class="bg-light rounded h-100 p-4">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="exampleInputPassword1" name="notice">
            </div>                                    
          </div>
        </div>
